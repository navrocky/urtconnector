...
, ui_(new Ui::AboutDialogClass)
{
    ...
    ui_->about_label->setText(prepare_html(tr(
    ...
    ui_->developers_label->setText(prepare_html(tr(
    ...
    ui_->thanks_label->setText(prepare_html(tr(
    ...
    ui_->translate_label->setText(prepare_html(tr(
